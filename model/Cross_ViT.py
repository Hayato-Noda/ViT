...
class CrossViT(nn.Module):
    def __init__(
        ...
        *,
        ...
        super().__init__()
        self.sm_image_embedder = Patch_Linear_emb(dim = sm_dim, image_size = image_size, patch_size = sm_patch_size, dropout = emb_dropout)
        self.lg_image_embedder = Patch_Linear_emb(dim = lg_dim, image_size = image_size, patch_size = lg_patch_size, dropout = emb_dropout)
